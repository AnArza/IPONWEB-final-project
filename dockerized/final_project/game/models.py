...
class Config(SingletonModel):
    ...
    - coefficient: Coefficient for using in calculations of the bib prices.
    """
...
class Bid(models.Model):
    ...
    Attributes:
        ...
        click_happened (bool): Whether or not a click occurred for the bid.
        conversion_happened (bool): Whether or not a conversion occurred for the bid.
        auth_ssp (bool): Whether or not the SSP is authorized.
    """
    ...
    auth_ssp = models.BooleanField(default=False, null=True)
